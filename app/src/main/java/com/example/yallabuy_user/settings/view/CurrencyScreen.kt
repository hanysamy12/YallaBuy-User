            ...
            when (currencyState) {
                is ApiResponse.Loading -> {
                    Row(
                        ...
                        Text("Updating rate...", color = colorResource(R.color.dark_blue))
                    }
                }

                is ApiResponse.Success -> {
                    val rate = (currencyState as ApiResponse.Success<Double>).data
                    Text(
                        text = "1 USD = $rate $selectedCurrency",
                ...
                is ApiResponse.Failure -> {
                    Text(
                        text = "Failed to fetch conversion rate",
                        color = Color.Red
                    )
                }
            }
